...
class Schedule:
    ...
    def schedule_generation(self):
        """
        Initialise a schedule which is generated by randomly choosing a
    ...
    def get_fitness(self) -> Tuple[float, list]:
        """
        Assess the fitness of each schedule according to a range of metrics
        """
    ...
    def check_specific_speciality(
        ...
        """
        Helper function to check prescence of specific words in specialities list for a student
        """
        if check_boolean:
    ...
    def add_score(self, score):
        """
        Helper function to add score value to all schedule entries
        """
        self.schedule_scores += score

    def populate_schedule(self) -> float:
        """
        Reconstruct schedules after mutations and recombination to make sure
    ...
    def recombination(
        ...
        """
        Produce offspring by combining two parent schedules,
    ...
    def mutation(self, num_mutations: int) -> Tuple["schedule", float]:
        """
        Mutate the location of one of the placements within a schedule
        """
    ...
    def schedule_quality_check(self):
        """
        Do some basic checks to make sure all rules have worked as desired
        """
    ...
    def save_report(self) -> str:
        """
        Save down the formatted versions of the schedules including
        a number of views
        """
        schedule = self.produce_dataframe()
