...
Placement teams in each Trust/organisation create individualised schedules for every learner that enters the Trust on placement. For larger Trusts, this means creating up 100s of schedules that meet the regulatory standards, curriculum requirements and placement capacity.
